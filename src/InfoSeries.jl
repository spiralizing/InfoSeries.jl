...
module InfoSeries
    ...
    export prob_marg, prob_conj, prob_conj3, prob_claplace, aut_corr, cross_corr, mutual_inf, auto_inf, histo, distro, transfer
    export gaps_notas!, gaps_silencios!, min_voces, max_tempo, serie_notas, indice, notas_hertz!, series_desdoble, filt_vozcsv, nota_intens!, note_vec, dfa_calc
