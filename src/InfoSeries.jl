...
module InfoSeries
    ...
    export consonance_series,gaps_notas!, gaps_silencios!, min_voces, max_tempo, serie_notas, indice, notas_hertz!, series_desdoble, filt_vozcsv, nota_intens!, note_vec, dfa_calc, rounding!, csvtoserie
