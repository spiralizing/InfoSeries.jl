...
module InfoSeries
    ...
    export tras_serie!,integrate_serie!, integrate, magnitude_serie, increment_serie, sign_serie, differ_serie, polyfits, polyeval2, eval2, run_avg, binning_dfa, inter_serie, out_dic, dfamod_calc, fast_fourier
